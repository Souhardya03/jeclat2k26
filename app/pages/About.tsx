...
const previousSponsorsRow3 = [
	...
	{ name: "city-life", image: "/images/sponsorImages/city-life.png" },
	{
		...
		image: "/images/sponsorImages/uttarbanga-sambad.png",
	},
...
export default function AboutPage() {
	...
	return (
		<div
			className={`relative min-h-screen w-full bg-[#050505] text-[#F2E8CF] ${montserrat.className} selection:bg-[#D4AF37] selection:text-black overflow-x-hidden`}>
			{/* --- FIXED BACKGROUND --- */}
			...
			<div className="relative z-10 w-full overflow-hidden">
				...
				<section className="min-h-screen flex flex-col justify-center items-center px-4 md:px-6 py-20 relative border-b border-[#D4AF37]/20">
					<motion.div
						...
						<motion.div
							variants={fadeInUp}
							className="flex items-center justify-center gap-3 md:gap-4 mb-2 md:mb-4 text-[#D4AF37]">
							<Star
								size={10}
								className="md:w-3 md:h-3"
							/>
							<span
								className={`${montserrat.className} text-[8px] md:text-[10px] tracking-[0.3em] md:tracking-[0.4em] uppercase`}>
								Est. 2026
							</span>
							<Star
								size={10}
						...
						<motion.div
							...
							<motion.div
								variants={{
									initial: {
										filter:
											"brightness(1) contrast(1) drop-shadow(0 0 0px rgba(245, 158, 11, 0))",
									},
									hover: {
										filter:
											"brightness(1.15) contrast(1.05) drop-shadow(0 0 15px rgba(245, 158, 11, 0.4))",
					...
					<motion.div
						...
						<div className="hidden md:block text-xs max-w-[200px] leading-relaxed">
							Celebrating art, culture, and competition in the heart of North
							Bengal.
						</div>
				...
				<section
					ref={statsRef}
					className="w-full py-16 md:py-24 px-6 border-b border-[#D4AF37]/20 bg-black/50 backdrop-blur-md">
					<motion.div
						initial="hidden"
						whileInView="visible"
						...
						<motion.div
							...
							<p className="text-[#F2E8CF]/60 text-sm leading-relaxed max-w-md mx-auto md:mx-0">
								Witness the magnitude of the largest cultural gathering in the
								region. A spectacle defined by numbers, driven by passion.
							</p>
						</motion.div>
					...
					<div className="max-w-7xl mx-auto px-6 grid lg:grid-cols-12 gap-12 items-center relative z-10">
						<motion.div
							...
							<motion.div variants={fadeInUp}>
								<span
									className={`${montserrat.className} text-[10px] md:text-xs border border-[#D4AF37] text-[#D4AF37] px-3 py-1 rounded-full uppercase tracking-widest`}>
									Flagship
								</span>
								<h2
									className={`${cinzel.className} text-4xl md:text-5xl lg:text-7xl font-bold text-white mt-6 mb-2`}>
									ELEMENTARY
								</h2>
								<p
									className={`${bodoni.className} text-xl md:text-2xl text-[#D4AF37] italic`}>
									"The Mystery Awaits"
								</p>
							</motion.div>
							...
							<motion.p
								variants={fadeInUp}
								className="text-[#F2E8CF]/70 text-base md:text-lg leading-loose font-light max-w-lg mx-auto lg:mx-0">
								An intellectual labyrinth designed for the elite. Decode clues,
								solve puzzles, and navigate the shadows to claim the ultimate
								glory.
							</motion.p>
							...
							<motion.div variants={fadeInUp}>
								<Link
									...
									<div className="flex items-center gap-4 text-[#D4AF37] border-b border-[#D4AF37]/30 pb-1 group-hover:border-[#D4AF37] transition-colors">
										<span className="uppercase tracking-[0.2em] text-xs md:text-sm font-semibold">
											Coming Soon
										</span>
										<ArrowUpRight
				...
				<section className="w-full pt-16 md:pt-20 pb-24 md:pb-40 relative border-t border-[#D4AF37]/20 bg-black/50 backdrop-blur-sm">
					<div className="max-w-7xl mx-auto px-6 relative z-10">
						...
						<motion.div
							...
							<h2
								className={`${italiana.className} text-4xl md:text-5xl lg:text-6xl text-white text-center`}>
								The Royal Alliance
							</h2>
							<p className="text-[#D4AF37] text-[10px] md:text-xs uppercase tracking-[0.3em] mt-4">
						...
						<motion.div
							...
							<div className="relative border-[#D4AF37]/40 border w-full max-w-[300px] md:max-w-lg hover:border-[#D4AF37]  aspect-[16/9] md:aspect-[16/8] group duration-300 cursor-default">
								...
								<div className="absolute inset-0 bg-[#050505] flex items-center justify-center overflow-hidden">
									<div className="absolute top-4 left-4 text-[8px] md:text-[10px] uppercase tracking-widest text-[#D4AF37]/70">
										Title Associate
									</div>
                       ...
                       <motion.div key={i} variants={fadeInUp} className="bg-[#050505] aspect-[4/3] flex items-center justify-center p-8 group hover:bg-[#0a0a0a] transition-colors relative">
						...
						<motion.div
							...
							<div className="absolute left-0 top-0 bottom-0 w-8 md:w-12 bg-[#D4AF37] flex items-center justify-center z-20 shadow-[0_0_20px_rgba(212,175,55,0.3)]">
								<span className="-rotate-90 text-[#050505] font-bold uppercase tracking-widest text-[10px] md:text-xs whitespace-nowrap">
									Legacy
								</span>
							</div>
							...
							<div className="ml-8 md:ml-12 space-y-8 md:space-y-12 overflow-hidden mask-gradient-sides">
								<MarqueeRow
									items={previousSponsorsRow1}
									direction="left"
									speed="45s"
								/>
								<MarqueeRow
									items={previousSponsorsRow2}
									direction="right"
									speed="50s"
								/>
								<MarqueeRow
									items={previousSponsorsRow3}
									direction="left"
									speed="55s"
								/>
							</div>
...
const MinimalStat = ({ value, label }: { value: string; label: string }) => (
	<motion.div
		variants={fadeInUp}
		className="flex flex-col gap-1 md:gap-2 group cursor-default items-center md:items-start">
		<div
			className={`${cinzel.className} text-4xl md:text-5xl lg:text-6xl text-white font-thin group-hover:text-[#D4AF37] transition-colors duration-500 drop-shadow-md`}>
			{value}
		</div>
		<div className="flex items-center gap-2">
			<div className="h-[1px] w-4 bg-[#D4AF37]/50 group-hover:w-8 transition-all duration-300 bg-[#D4AF37]"></div>
			<span className="text-[10px] md:text-xs uppercase tracking-widest text-[#F2E8CF]/60">
				{label}
			</span>
		</div>
	</motion.div>
		...
		<motion.div
			...
			<div className="absolute inset-0 bg-[#050505] border border-[#D4AF37]/30 rounded-sm overflow-hidden shadow-[0_0_50px_rgba(0,0,0,0.5)] transition-all duration-200 group hover:border-[#D4AF37]/60">
				...
				<div className="absolute bottom-6 md:bottom-8 left-6 md:left-8 right-6 md:right-8 border-t border-[#D4AF37]/50 pt-4 transform translate-z-10">
					<div
						className={`${cinzel.className} text-2xl md:text-3xl text-white drop-shadow-md`}>
						2026
					</div>
					<div className="text-[10px] md:text-xs text-[#D4AF37] uppercase tracking-widest mt-1">
						The Grand Mystery
					</div>
				</div>
			</div>
		...
		<div className="relative overflow-hidden w-full">
			<div
				...
				{allItems.map((sponsor, idx) => (
					<div
						key={idx}
						className="relative w-24 h-10 md:w-32 md:h-12 flex items-center justify-center opacity-60 hover:opacity-100 transition-opacity duration-300 scale-95 hover:scale-105">
						<Image
							src={sponsor.image}
							alt={sponsor.name}
							fill
