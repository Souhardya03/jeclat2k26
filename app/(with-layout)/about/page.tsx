			...
			<div className="relative z-10 flex flex-col items-center w-full">
				...
				<section className="relative w-full min-h-[90vh] flex flex-col items-center justify-center px-4  py-20 ">
					...
					<motion.div
						...
						<div
							className={`${fauna.className} text-center space-y-8 text-lg md:text-xl text-gray-200 leading-relaxed`}>
							<EncryptedText
							...
							<motion.div
								...
								<span className="text-yellow-500 text-2xl drop-shadow-[0_0_5px_gold]">
									❖
								</span>
							</motion.div>
				...
				<section className="w-full py-24 px-4">
					<motion.div
						...
						<motion.div
							...
							className="h-1 bg-gradient-to-r from-transparent via-yellow-600 to-transparent"></motion.div>
					</motion.div>
					...
					<motion.div
						...
						<motion.div variants={fadeInLeft}>
							<StatCard
								icon={
									<Trophy className="w-16 h-16 text-yellow-400 opacity-90" />
								}
								number="25+"
								label="Events"
							/>
						...
						<motion.div variants={fadeInUp}>
							<StatCard
								icon={
									<Users className="w-16 h-16 text-yellow-400 opacity-90" />
								}
								number="10K+"
								label="Footfall"
							/>
						...
						<motion.div variants={fadeInRight}>
							<StatCard
								icon={
									<Crown className="w-16 h-16 text-yellow-400 opacity-90" />
								}
								number="Big"
								label="Prize Pool"
							/>
						...
						<div className="relative z-10 flex flex-col md:flex-row items-center p-8 md:p-16 gap-12">
							<motion.div
								...
								<motion.p
									...
									Embark on a digital odyssey with{" "}
									<span className="text-yellow-400 font-bold">
										JECLAT 2K26's
									</span>{" "}
									pièce de résistance. Immerse yourself in the enigmatic world
									of mystery puzzles, code-cracking, and intricate level
									navigation.
								</motion.p>
							...
							<motion.div
								...
								<motion.div
									...
									<MapPin
										size={64}
										className="text-yellow-600 drop-shadow-[0_0_10px_rgba(202,138,4,0.5)]"
									/>
									<div className="absolute bottom-6 text-xs uppercase tracking-[0.3em] text-[#8d6e63]">
										Top Secret
									</div>
								</motion.div>
							</motion.div>
				...
				<section className="w-full pt-32 pb-24 relative overflow-hidden">
					...
					<div className="relative z-10 max-w-7xl mx-auto px-6">
						...
						<motion.div
							...
							<p
								className={`${fauna.className} text-yellow-100/60 text-lg tracking-widest uppercase`}>
						...
						<div className="mb-24">
							<motion.h3
								...
								<motion.span
									...
									viewport={{ once: true }}
									transition={{ duration: 0.8 }}
									className="w-12 h-px bg-yellow-900 origin-right"></motion.span>
								Brand Partners
								<motion.span
									initial={{ scaleX: 0 }}
									whileInView={{ scaleX: 1 }}
									viewport={{ once: true }}
									transition={{ duration: 0.8 }}
									className="w-12 h-px bg-yellow-900 origin-left"></motion.span>
							</motion.h3>
...
const MarqueeRow = ({
	...
	<div className="relative overflow-hidden w-full group">
		<div
			className={`flex gap-16 w-max ${direction === "left" ? "animate-marquee-left" : "animate-marquee-right"} group-hover:[animation-play-state:paused]`}>
