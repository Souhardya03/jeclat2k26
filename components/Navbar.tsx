	...
	return (
		<nav className="fixed top-4 left-0 right-0 flex justify-center px-4 z-50">
			...
			<motion.div
				...
				className="hidden lg:flex absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-full max-w-[90rem] items-center justify-center gap-6 z-0 pointer-events-none text-yellow-500/40">
				<motion.div
					initial={{ scaleX: 0 }}
					animate={{ scaleX: 1 }}
